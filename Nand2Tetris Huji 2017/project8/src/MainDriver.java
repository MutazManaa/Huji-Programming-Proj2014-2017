		...
		while (parser.hasMoreCommands())
		{
		    try {
                ...
                switch (parser.commandType()) {
                    ...
                    case C_PUSH:
						cdWr.WritePush(parser.arg1(), parser.arg2());
						break;
                    case C_POP:
                        cdWr.WritePop(parser.arg1(), parser.arg2());
                        break;

                    case C_CALL:
                        cdWr.writeCall(parser.arg1(), parser.arg2());
                        break;
                    ...
                    case C_FUNCTION:
                        cdWr.writeFunction(parser.arg1(), parser.arg2());
                        break;

                    case C_GOTO:
                        cdWr.writeGoto(parser.arg1());
                        break;

                    case C_IF:
                        cdWr.writeIf(parser.arg1());
                        break;

                    case C_LABEL:
                        cdWr.wrtiteLabel(parser.arg1());
