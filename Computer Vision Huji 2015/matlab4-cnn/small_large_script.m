function small_large_script()
%% WELCOME TO THE SMALL NETWORK
...
eta    = @(t)(0.005); % Learning rate - eta(t) returns the value for iteration t
...
net_arch = {...
    ...
    struct('type','relu','inInd',3,'outInd',3),  ...
    struct('type','maxpool','inInd',3,'outInd',4,'kernelsize',pool_kernel,'stride',pool_stride), ...
    struct('type','conv','inInd',4,'outInd',5,'kernelsize',conv_kernel,'stride',conv_stride,'nOutChannels',50,'bias_filler',0),...
